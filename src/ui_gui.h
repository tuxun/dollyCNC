...
public:
    ...
    void setupUi(QMainWindow *gui)
    {
        ...
        actionV_rifier_mahine->setObjectName(QString::fromUtf8("actionV_rifier_mahine"));
        ...
        actionConnecter->setObjectName(QString::fromUtf8("actionConnecter"));
        actionLibrary_path = new QAction(gui);
        actionLibrary_path->setObjectName(QString::fromUtf8("actionLibrary_path"));
        actionLittle_height_1024px = new QAction(gui);
        actionLittle_height_1024px->setObjectName(QString::fromUtf8("actionLittle_height_1024px"));
        actionNormal_15_fullscreen_test = new QAction(gui);
        actionNormal_15_fullscreen_test->setObjectName(QString::fromUtf8("actionNormal_15_fullscreen_test"));
        actionAutodetect = new QAction(gui);
        actionAutodetect->setObjectName(QString::fromUtf8("actionAutodetect"));
        actionImport = new QAction(gui);
        actionImport->setObjectName(QString::fromUtf8("actionImport"));
        actionToggle_Library = new QAction(gui);
        actionToggle_Library->setObjectName(QString::fromUtf8("actionToggle_Library"));
        ...
        dessin->setObjectName(QString::fromUtf8("dessin"));
        ...
        gridTabWidget_2Page1->setObjectName(QString::fromUtf8("gridTabWidget_2Page1"));
        ...
        testmoveButton->setObjectName(QString::fromUtf8("testmoveButton"));
        ...
        widget1->setGeometry(QRect(0, 0, 479, 26));
        ...
        gcodesendText->setObjectName(QString::fromUtf8("gcodesendText"));

        gridLayout_2->addWidget(gcodesendText, 3, 1, 1, 1);

        getstatutButton = new QPushButton(gridLayoutWidget);
        getstatutButton->setObjectName(QString::fromUtf8("getstatutButton"));
        ...
        dri_statelabel->setObjectName(QString::fromUtf8("dri_statelabel"));

        gridLayout_2->addWidget(dri_statelabel, 0, 1, 1, 1);

        dev_filelabel = new QLabel(gridLayoutWidget);
        dev_filelabel->setObjectName(QString::fromUtf8("dev_filelabel"));
        ...
        gcodesendButton->setObjectName(QString::fromUtf8("gcodesendButton"));
        ...
        drawtocodeButton->setObjectName(QString::fromUtf8("drawtocodeButton"));
        ...
        hgButton->setObjectName(QString::fromUtf8("hgButton"));

        gridLayout->addWidget(hgButton, 1, 0, 1, 1);

        hdButton = new QPushButton(verticalTabWidgetPage1);
        hdButton->setObjectName(QString::fromUtf8("hdButton"));
        ...
        movewaylabel->setObjectName(QString::fromUtf8("movewaylabel"));
        ...
        menuStatut->setObjectName(QString::fromUtf8("menuStatut"));
        menuAide = new QMenu(menuBar);
        menuAide->setObjectName(QString::fromUtf8("menuAide"));
        menuSettings = new QMenu(menuBar);
        menuSettings->setObjectName(QString::fromUtf8("menuSettings"));
        menuScreen_size = new QMenu(menuSettings);
        menuScreen_size->setObjectName(QString::fromUtf8("menuScreen_size"));
